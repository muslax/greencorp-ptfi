...
export default function Ikan({ responden, isOwner, daftar, mutate }) {
        ...
        <table className="min-w-full border-t border-blue-200">
          <tbody>
            <tr className="border-b border-blue-200 bg-blue-200 bg-opacity-60 font-medium whitespace-nowrap">
              ...
              <td className="p-2">Jenis ikan</td>
          ...
          {daftar.filter((d) => { return d.tipe == "ikan" }).map((d, i) => (
            <tbody key={d._id}>
